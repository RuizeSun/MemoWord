...
class Ap:
	...
	def _add_new_entry_mode(A):
		...
		A.i_var.set(O(B));A.selected_entry_id=F;A.unsaved_changes=G;A.add_new_entry_button.pack_forget()
	def _update_entry(A):
		D=A._get_form_data()
		if D is F:return
		B=F
